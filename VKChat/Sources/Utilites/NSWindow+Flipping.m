...
@property (retain) NSView *animatingContentView;
...
- (id)initWithFrame:(NSRect)frameRect andOriginalFrame:(NSRect)originalFrameRect
{
    ...
    transitionFilter = [[CIFilter filterWithName: NSWindowFlippingViewAnimationTransitionFilterName] retain];
...
- (void)setInitialWindow:(NSWindow *)anInitialWindow finalWindow:(NSWindow *)aFinalWindow andFlippingDirection:(BOOL)isForward
{
    ...
    initialWindow = [anInitialWindow retain];
    finalWindow = [aFinalWindow retain];
